document.addEventListener("DOMContentLoaded", function(){
    ...
    let url2 = "css/constraste.css"
    let contraste = document.getElementById("contraste")
    let semcontraste = document.getElementById("sem_contraste")
    ...
    let tag = document.getElementsByClassName("acess")//<link rel="stylesheet type ="text/css" href =url>
